...
public class CardFlowSyn {
    ...
    public Map<String, Object> CalculationBatchFlow(String iccid, Double ApiUsed, Map<String, Object> map,
    ...
    public Map<String, Object> CalculationFlowCommon(String iccid, Double ApiUsed, Map<String, Object> map,
        ...
        Double SumErrorFlow_D = SumErrorFlow != null && SumErrorFlow.length() > 0 ? Double.parseDouble(SumErrorFlow)
                : 0.0;
