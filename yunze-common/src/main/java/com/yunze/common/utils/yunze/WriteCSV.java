...
public class WriteCSV {
     ...
     */
    public void Write(String fileName, List<Map<String, Object>> mapList, String[] withHeader, String OutUrl,
            String[] keys) {
     ...
     */
    public void Write(String fileName, List<Map<String, Object>> mapList, String[] withHeader, String OutUrl,
            String[] keys, String Flieurl, boolean noAddress) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new RuntimeException("CSV文件写入失败: " + e.getMessage(), e);
        }
     ...
     * @param keys          输出列
     */
    public void OutCSV(List<Map<String, String>> list, String fileName_flow, String description, String agentName,
            String result, String Outcolumns[], String keys[], String IdKey) {
     ...
     */
    public void OutCSV(List<Map<String, String>> list, String fileName_flow, String description, String agentName,
            String result, String Outcolumns[], String keys[]) {
     ...
     * @param keys          输出列
     */
    public void OutCSVObj(List<Map<String, Object>> list, String fileName_flow, String description, String agentName,
            String result, String Outcolumns[], String keys[]) {
     ...
     */
    public void OutCSVObj(List<Map<String, Object>> list, String fileName_flow, String description, String agentName,
            String result, String Outcolumns[], String keys[], int OutSize) {
     ...
     * @param OutSize       多少条数据进行一次输出
     */
    public void OutCSVObj(List<Map<String, Object>> list, String fileName_flow, String Outcolumns[], String keys[],
            int OutSize) {
        List<Map<String, Object>> out_list = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
            Map<String, Object> out_map = new HashMap<String, Object>();
     ...
     */
    public void OutCSVObj(List<Map<String, Object>> list, String fileName_flow, String Outcolumns[], String keys[],
            Map<String, Object> defOutcolumns, int OutSize) {
        List<Map<String, Object>> out_list = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
            Map<String, Object> out_map = new HashMap<String, Object>();
            Map<String, Object> cardIndex = list.get(i);
     ...
     * @param OutSize       多少条数据进行一次输出
     */
    public void OutCSVStr(List<Map<String, String>> list, String fileName_flow, String Outcolumns[], String keys[],
            Map<String, Object> defOutcolumns, int OutSize) {
        List<Map<String, Object>> out_list = new ArrayList<>();
        for (int i = 0; i < list.size(); i++) {
            Map<String, Object> out_map = new HashMap<String, Object>();
     ...
     * @return
     */
    public static Map<String, Object> WriteDic(Map<String, Object> CarMap, List<Map<String, Object>> DictDataArr,
            String basis, String fieldName) {
     ...
     */
    public void CsvOrExcle(String path, HttpServletResponse response, boolean is_download, boolean doesNotParseBool)
            throws IOException {
        // 获取当前文件下载 地址
        File file2 = new File("");
        ...
        if (pathArr != null && pathArr.length > 0) {
            ...
            if (file != null && file.exists()) {
                ...
                // cvs 文件 转换
                // fileConverter.generateExcel(fileConverter.CSVexcel(path), downloadUrl,
                // "card",50000);
    ...
    public static void main(String[] args) {
        ...
        Map<String, List<Map<String, Object>>> collect = dataList.stream().collect(Collectors
                .groupingBy(scope -> scope.get("dept_id").toString() + '-' + scope.get("user_id").toString()));
