 ...
 */
@Slf4j
@Component("emailCCRenewal")
public class EmailCCRenewal {

    @Resource
    private RabbitTemplate rabbitTemplate;

    public void CCExecution(Integer cc_count) {
        //1.创建路由 绑定 生产队列 发送消息
        //导卡 路由队列
        String polling_queueName = "admin_emailCCRenewal_queue";
        String polling_routingKey = "admin.emailCCRenewal.queue";
        ...
        try {
            ...
            start_type.put("type","CCExecution");
