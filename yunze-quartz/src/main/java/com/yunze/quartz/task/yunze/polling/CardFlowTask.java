...
public class CardFlowTask {
    ...
    public void pollingCardFlow(Integer time) {
        //1.创建路由 绑定 生产队列 发送消息
        //导卡 路由队列
        String polling_queueName = "admin_pollingCardFlowTest_queue";
        String polling_routingKey = "admin.pollingCardFlowTest.queue";
        ...
        try {
            ...
            start_type.put("Masage", "备份 执行 pollingCardFlowTest_queue ");//启动类型
