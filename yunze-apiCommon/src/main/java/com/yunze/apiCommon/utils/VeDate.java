...
public class VeDate {
 ...
 /**
  * 取得 transid 生成格式为 appid + YYYYMMDDHHMMSS +k位随机数
  *
  * @param k 表示是取几位随机数，可以自己定
  */
 public static String getTransid(String appid, int k) {
  String YYYYMMDDHHMMSS = "20211126123030";
  String rdm = getRandom(k);
  System.out.println(appid);
  System.out.println(YYYYMMDDHHMMSS);
  System.out.println(getRandom(k));
  return appid + YYYYMMDDHHMMSS + rdm;
 }
  ...
  * @return
  */
 public static String getMonthDate(String yyyy_MM_dd_HH_mm_ss, int month) throws ParseException {
  SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
 ...
 public static void main(String[] args) throws Exception {
  ...
  System.out.println(v.getBeforeAfterDate("2021-11-21",180));
/*	 
